...
@section('content')
    ...
    <div class="cms-options">
        <div class="cms-options-title-action">
            <p class="cms-options-title lead">Napredni Nivo</p>
        </div>
    </div>
        ...
        <div class="panel-body">
            <div class="tab-content">
                <div class="tab-pane fade in active" id="tab-1">
                    ...
                    {!! Form::open(['route' => 'admin.advance-gallery-add', 'files' => true, 'class' => 'form-horizontal']) !!}
                    ...
                    <!-- Image ALT Form Input -->
                        ...
                        <div class="row">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <a href="{{route('admin.advance-gallery')}}" class="btn btn-link pull-right">Cancel</a>
                            </div>
                        </div>
                        {!! Form::close() !!}
                    </fieldset>
