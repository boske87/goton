...
@section('content')
@include('admin/advanced_module/js_edit')
...
<ol class="breadcrumb">
    ...
    <li><a href="{{ url('admin/advanced_module') }}">{{ $template['title'] }}</a></li>
...
{!! Form::model($item, ['method' => 'PATCH', 'route' => ['admin.advanced_module.update', $item->id], 'class' => 'form-horizontal', 'files' => true]) !!}
        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="tab-1">
                <fieldset>
                    ...
                    @include('admin.layouts.modules.slug_input')
                    ...
                    <!-- Illustration  Form Input -->
                    @include('admin.layouts.modules.file_input', [
                      'label' => 'Image',
                      'inputName' => 'image',
                      'directory' => 'advanced_module',
                      'img' => $item->image,
                      'imgConfig' => ['h' => 200]
                    ])

{{--                    @include('admin.layouts.modules.file_input', ['inputName' => 'image', 'label' => 'Image', 'directory' => 'advanced_module'])--}}
        ...
        <div class="row">
            <div class="col-sm-offset-2 col-sm-10">
                ...
                {!! link_to_route('admin.advanced_module.index', 'Cancel', null, ['class' => 'btn btn-link pull-right']) !!}
            </div>
        </div>
    </div>
</div>
