...
@section('index_header')
    ...
    <div class="cms-options">
        <div class="cms-options-title-action">
            ...
            <h3 class="cms-options-title">Pocetni nivo galerija</h3>
            {!! link_to_route('admin.basic-gallery-add', 'Add', null, ['class' => 'cms-options-action btn btn-lg btn-primary']) !!}
        </div>
                    ...
                    <tr id="{{ $item->id }}" class="{{ $item->deleted_at ? 'danger' : ''}}">
                        ...
                        <td class="cms-column-actions">
                            <div class="btn-group btn-group-xs cms-table-actions">
                                {!! Form::open(['method' => 'DELETE', 'route' => ['admin.basic-gallery-delete', $item->id], 'onsubmit' => "return confirm('Are you sure you want to DELETE this item?')"]) !!}
