...
@section('index_header')
    ...
    <div class="cms-options">
        <div class="cms-options-title-action">
            ...
            {!! link_to_route('admin.blog_category.create', 'Add', null, ['class' => 'cms-options-action btn btn-lg btn-primary']) !!}
        </div>
            ...
            <table id="sortable-table" class="table">
                ...
                @foreach($items as $item)
                    <tr id="{{ $item->id }}">
                        ...
                        <td><a href="{{ route('admin.blog_category.edit', $item->id) }}">{{ $item->name }}</a></td>
                        ...
                        <td class="cms-column-actions">
                            <div class="btn-group btn-group-xs cms-table-actions">
								<a href="{{route('blog.categories',$item->id)}}" target="_blank" type="button" class="btn btn-default"><span class="entypo entypo-eye"></span></a>
								<a href="{{ route('admin.blog_category.edit', $item->id) }}" type="button" class="btn btn-default"><span class="entypo entypo-pencil"></span></a>
                                {!! Form::open(['method' => 'DELETE', 'route' => ['admin.blog_category.destroy', $item->id], 'onsubmit' => "return confirm('Are you sure you want to DELETE this item?')"]) !!}
