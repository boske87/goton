        ...
        <div class="panel-body">
                ...
                <div class="tab-pane fade in active" id="tab-1">
                    <fieldset>
                        ...
                        <div class="form-group{!! $errors ->has('parent_category_id') ? ' has-error' : '' !!}">
                            ...
                            <div class="col-sm-10">
                                {!! Form::select('parent_category_id', $categories, 0, ['class' => 'form-control']) !!}
                        ...
                        <div class="form-group{!! $errors ->has('search_placeholder') ? ' has-error' : '' !!}">
                            ...
                            <div class="col-sm-10">
                                {!! Form::text('search_placeholder', null, ['class' => 'form-control']) !!}
            ...
            <div class="row">
                <div class="col-sm-offset-2 col-sm-10">
                    ...
                    <a href="{{ url('admin/category') }}" class="btn btn-link pull-right">Cancel</a>
                </div>
            </div>
        </div>
    </div>
