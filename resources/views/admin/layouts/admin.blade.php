...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('assets/admin/css/screen.css') }}">
        <link rel="stylesheet" href="{{ asset('assets/admin/css/dev.css') }}">
        ...
        <div class="wrap">
            ...
            <div class="container container-main container-main-has-sidebar">
                <div class="row row-main">
                    <div class="col-md-10 js-main">
                        @yield('content')
                    </div>
                        @include('admin.layouts.navigation.sidebar_nav')
                </div> <!-- =row-main -->
            </div> <!-- =container-main -->
            <div class="push"></div>
        </div><!-- =wrap -->
