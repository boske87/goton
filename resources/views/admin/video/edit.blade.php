        ...
        <div class="panel-body">
            <div class="tab-content">
                <div class="tab-pane fade in active" id="tab-1">
                    ...
                    <fieldset>
                        {!! Form::model($item, ['method' => 'PATCH', 'route' => ['admin.videos.update', $item->id], 'class' => 'form-horizontal', 'files' => true]) !!}

                                <!-- Token Form Input -->
                        <div class="form-group{!! $errors ->has('caption') ? ' has-error' : '' !!}">
                            {!! Form::label('token', 'Video ID*', ['class' => 'col-sm-2 control-label']) !!}
                            <div class="col-sm-10">
                                {!! Form::text('token', $item->token, ['class' => 'form-control']) !!}
                        ...
                        <div class="form-group{!! $errors ->has('video_type') ? ' has-error' : '' !!}">
                            ...
                            <div class="col-sm-10">
                                {!! Form::select('video_type', Config::get('project.video_type'), $item->video_type, ['class' => 'form-control']) !!}
