...
<head>
    ...
    <link href="/admin_tmpl/{{ asset('assets/admin/plugins/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css"/>

    <link href="/admin_tmpl/{{ asset('assets/admin/plugins/bootstrap/css/bootstrap-responsive.min.css')}}" rel="stylesheet" type="text/css"/>

    <link href="/admin_tmpl/{{ asset('assets/admin/plugins/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css"/>

    <link href="/admin_tmpl/{{ asset('assets/admin/css/style-metro.css')}}" rel="stylesheet" type="text/css"/>

    <link href="/admin_tmpl/{{ asset('assets/admin/css/style.css')}}" rel="stylesheet" type="text/css"/>

    <link href="/admin_tmpl/{{ asset('assets/admin/css/style-responsive.css')}}" rel="stylesheet" type="text/css"/>

    <link href="/admin_tmpl/{{ asset('assets/admin/css/themes/default.css')}}" rel="stylesheet" type="text/css" id="style_color"/>

    <link href="/admin_tmpl/{{ asset('assets/admin/plugins/uniform/css/uniform.default.css')}}" rel="stylesheet" type="text/css"/>

    <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/plugins/select2/select2_metro.css')}}" />

    <!-- END GLOBAL MANDATORY STYLES -->

    <!-- BEGIN PAGE LEVEL STYLES -->

    <link href="/admin_tmpl/{{ asset('assets/admin/css/pages/login.css')}}" rel="stylesheet" type="text/css"/>
...
<script src="{{ asset('assets/admin/plugins/jquery-1.10.1.min.js')}}" type="text/javascript"></script>
...
<script src="{{ asset('assets/admin/plugins/bootstrap-hover-dropdown/twitter-bootstrap-hover-dropdown.min.js')}}" type="text/javascript" ></script>
...
<script src="{{ asset('assets/admin/plugins/jquery.cookie.min.js')}}" type="text/javascript"></script>
...
<script src="{{ asset('assets/admin/scripts/app.js')}}" type="text/javascript"></script>

<script src="{{ asset('assets/admin/scripts/login.js')}}" type="text/javascript"></script>
